...
#[test]
fn __bindgen_test_layout_pair_open0_unsigned_long_unsigned_long_close0_instantiation() {
    assert_eq!(
        ::std::mem::size_of::<pair<::std::os::raw::c_ulong, ::std::os::raw::c_ulong>>(),
        16usize,
        concat!(
            "Size of template specialization: ",
            stringify ! ( pair < :: std :: os :: raw :: c_ulong , :: std :: os :: raw :: c_ulong > )
        )
    );
    assert_eq!(
        ::std::mem::align_of::<pair<::std::os::raw::c_ulong, ::std::os::raw::c_ulong>>(),
        8usize,
        concat!(
